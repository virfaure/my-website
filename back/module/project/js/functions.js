...
function loadList(){	
	...
	//SEARCH FORM Element
		...
		// Title
		$("#search_project_name").keyup( function () {
			/* COLUMN 3 - Filter on the column (the index) of this element */
			oTable.fnFilter($(this).val(), 2);
		});
		
		// Page
		$("#search_project_status").change( function () {
			/* COLUMN 3 - Filter on the column (the index) of this element */
	...
	oTable.dataTable( {
		...
		"aaSorting": [[7,'desc']],																// by default : sorting by 4- 'end date' ASC
		"aoColumns": [ 
			...
			{ "sWidth" : "100px", "sClass": "actions", "bSortable": false },
			{"sType": "dateLainoaSimple"}														// 7 - date
		],
