...
function loadList(){	
	...
	//SEARCH FORM Element
		...
		// Status
		$("#search_language_status").change( function () {
	...
	oTable.dataTable( {
		...
		"aoColumns": [ 
			...
			null, 																				// 2 - name : by default
			null, 																				// 3 - locale : by default
			{ "sWidth" : "100px", "sClass": "actions", "bSortable": false },					// 4 - image : by default
			{ "bVisible" : false},																// 5 - status ID : HIDDEN
			{ "sWidth" : "100px", "sClass": "actions", "bSortable": false }						// 6 - status Name
		],
